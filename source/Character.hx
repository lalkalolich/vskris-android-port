...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'kris':
				// Kris ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('Kris/Kris_Assets');
				frames = tex;
			...
			case 'jevil':
				tex = Paths.getSparrowAtlas('jevil/jevil');
				frames = tex;
				animation.addByPrefix('singUP', 'spooky UP NOTE', 24, false);
				animation.addByPrefix('singDOWN', 'spooky DOWN note', 24, false);
				animation.addByPrefix('singLEFT', 'note sing left', 24, false);
				...
				addOffset('danceLeft', 0, -225);
				addOffset('danceRight', 0, -225);

				addOffset("singUP", -20, -224);
				addOffset("singRIGHT", -130, -214);
				addOffset("singLEFT", 130, -210);
				addOffset("singDOWN", -50, -330);
